...
public interface UserService {
  ...
  UserNameDto findId(FindIdRequest findIdRequest);
  ...
  void updateUserInfoByUserUpdateRequest(NicknameDto nicknameDto, MultipartFile img, User user)
      throws IOException;

  void setVillage(LocationRequest locationRequest, String username);

  void refreshAccessToken(String refreshToken, UserNameDto userNameDto,
